        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center relative z-10">
          ...
          <div className="hidden md:block">
            <a 
              ...
              className="relative px-6 py-2.5 rounded-full overflow-hidden group bg-transparent border border-white/20 text-white text-sm font-medium tracking-wider hover:border-white/60 transition-colors duration-300 block"
