...
import imgSpiderman from '../assets/spiderman/spideyl (1).png';
import imgMan from '../assets/man/man 1.png';
      ...
      <div className="max-w-[90rem] w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
        ...
        >
          ...
          <img
            ...
            className="absolute inset-0 w-full h-full object-cover object-top grayscale opacity-60 mix-blend-luminosity brightness-75 transition-all duration-700 scale-[0.8] group-hover:scale-[0.85]"
          />
          ...
          >
            <img
              ...
              className="absolute inset-0 w-full h-full object-cover object-top scale-[0.8] group-hover:scale-[0.85] transition-transform duration-[2s] ease-out"
            />
