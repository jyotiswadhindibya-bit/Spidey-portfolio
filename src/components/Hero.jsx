...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uImageResolution1: { value: new THREE.Vector2(1920, 1080) },
      uImageResolution2: { value: new THREE.Vector2(1920, 1080) },
      uOffset1: { value: new THREE.Vector2(0.0, 0.0) },
      uOffset2: { value: new THREE.Vector2(0.05, 0.0) }, // Slight shift left for man
      uScaleFactor2: { value: 1.15 } // Increased from 0.9 to make image smaller
    };
